...
x = sr1(ARP(pdst=routeur_ip), iface="eth0", timeout=2) 
routeur_mac=x.hwsrc
...
class ARP_one(Frame):
	def __init__(self, master):
		...
		Frame.__init__(self, master)
		self.multiuser = Button(self, text="►Multi user◄", command=lambda: master.switch_frame(ARP_all),bg='#ae3333')
		self.label_if = Label(self, text="ARP Spoofer | One Target", font = ( "Calibri" , 20 ), bg='#ae3333', pady=30, padx=128, width = 25)
		self.label_if.pack()
		self.label= Label(self, text="", bg="black")
		self.label.pack()
...
class ARP_all(Frame):
	def __init__(self, master):
		...
		self.label_if = Label(self, text="ARP Spoofer | All Network", font = ( "Calibri" , 20 ), bg='#ae3333', pady=30, padx=128, width=25)
		self.label_if.pack()
...
class DNS_attk(Frame):
	def __init__(self, master):
		...
		self.label_if = Label(self, text="DNS Spoofer", font = ( "Calibri" , 20  ), bg='#16537e', pady=30, padx=128, width = 25)
		self.label_if.pack()
...
class about_nc(Frame):
	def __init__(self, master):
		...
		self.label_if = Label(self, text="About", font = ( "Calibri" , 20 ), width = 25, bg='#ae3333', pady=30, padx=128)
		self.label_if.pack()
